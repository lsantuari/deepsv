...
Structural variant detection with Deep learning
...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_deepsv``)
...
* For convenience, the package version is stored in a single place: ``deepsv/__version__.py``. For updating the version number, you only have to change this file.
...
To install deepsv, do:

.. code-block:: console

  git clone https://github.com/https://github.com/GooglingTheCancerGenome/deepsv.git
  cd deepsv
  pip install .
...
If you want to contribute to the development of DeepSV,
